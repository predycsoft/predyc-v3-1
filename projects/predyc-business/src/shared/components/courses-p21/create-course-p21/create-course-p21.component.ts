...
@Component({
  selector: "app-create-course-p21",
  templateUrl: "./create-course-p21.component.html",
  styleUrls: ["./create-course-p21.component.css"],
})
export class CreateCourseP21Component {
  constructor(
