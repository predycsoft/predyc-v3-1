...
export class EnterprisePresentationFormComponent {
	constructor(public icon: IconService, private alertService: AlertsService, private storage: AngularFireStorage) {}

	@Input() enterprise: Enterprise;
	@Input() isOtherFormEditing: boolean;
	@Output() onEnterprisePresentationChange: EventEmitter<{ formValue: FormGroup; isEditing: boolean }> =
		new EventEmitter<{ formValue: FormGroup; isEditing: boolean }>();
