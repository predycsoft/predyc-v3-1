...
export class CourseByStudent {
  ...
  public studyPlanOrder: number = 0;

  public static fromJson(
    CourseByStudentJson: CourseByStudent
  ): CourseByStudent {
    ...
    courseByStudent.studyPlanOrder = CourseByStudentJson.studyPlanOrder;
  ...
  toJson(): CourseByStudentJson {
    return {
      ...
      studyPlanOrder: this.studyPlanOrder,
    };
  }
}
